...
it('map(1) should throw a TypeError with a message "The first parameter must be a array"', () => {
      let error
      try {
            map(1)
      } catch (e) {
...
it('map([1,2], "function") should throw a TypeError with a message "The second parameter must be a function"', () => {
      let error
      try {
            map([1,2], 'function')
      } catch (e) {
